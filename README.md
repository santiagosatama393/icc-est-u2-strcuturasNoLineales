...
---
**Descripción:** En esta práctica se utilizó una clase genérica BinaryTree<T> para almacenar distintos tipos de datos que implementen Comparable. Se creó la clase Persona con los atributos nombre y edad, definiendo un criterio de comparación mediante el método compareTo. Además, en la clase BinaryTree se desarrollaron los recorridos básicos del árbol trabajados en la práctica anterior.
